...
namespace XpimRevitAddIn.Export.Json3D
{
    ...
    class Json3DExportContext : CommonExportContent
    {
        private Json3DExportConfigs _Cfgs = new Json3DExportConfigs();
        ...
        private Json3DExportManager _Manager = new Json3DExportManager();
        ...
        public Json3DExportContext(Document doc, string directory, string fileName, int levelOfDetail, IConverter converter, Json3DExportConfigs configs = null)
        {
        ...
        {
            Json3DContainer container = _Manager.Finish();
            IList<Element> allInstanceElements = this.GetAllInstanceElements();
            container.elements = ExportElementJson.GetElementParamterJsons(this.Doc, allInstanceElements);
            container.modelTree = ExportModelTreeJson.GetModelTreeJson(this.Doc, allInstanceElements);
